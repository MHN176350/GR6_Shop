...
<html>
    <head>
        <title>Paypal - Electro Shop</title>
    ...
    <body>
        <form id="payment-form" action="your-payment-handler.php" method="post">
            ...
            <label style="font-size: larger; font-family: cursive; font-weight: bolder" for="amount">Payment Amount (USD):</label>
            ...
            <style>
                body {
                    margin-top: 20px;
                    background-image: url('images/paypal3.jpg');
                ...
                paypal.Buttons({
                    ...
                    onApprove: function (data, actions) {
                        ...
                        return actions.order.capture().then(function (details) {
                            ...
                            setTimeout(function () {
                                window.location.href = 'paypal?amount=' + paymentAmount;
                            }, 10000);
                        });
                    }
