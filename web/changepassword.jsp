                ...
                <div class="signup-content">
                    <form method="POST" action="changepassword" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="opassword" id="password" placeholder="Enter your old password" required="">
                            <span toggle="#password" class="zmdi zmdi-eye field-icon toggle-password"></span>
                        </div><!-- comment -->
                        
                        <div class="form-group">
                            <input type="text" class="form-input" name="npassword" id="password" placeholder="New Password" required="">
                            <span toggle="#password" class="zmdi zmdi-eye field-icon toggle-password"></span>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="nrepassword" id="password" placeholder="Re-Password" required="">
                            <span toggle="#password" class="zmdi zmdi-eye field-icon toggle-password"></span>
                        </div>
