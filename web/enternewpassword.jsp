...
<html lang="en">
    <head>
        ...
        <title>Reset Password - Electro Shop </title>
                ...
                <div class="signup-content">
                    <form method="POST" action="reset" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-input" name="npassword1" id="password1" placeholder="New Password" required="">
                            <span toggle="#password1" class="zmdi zmdi-eye field-icon toggle-password"></span>
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-input" name="nrepassword1" id="password2" placeholder="Re-Password" required="">
                        ...
                        <div class="error">
                            ...
                            <div class="alert alert-danger">
                                ...
                                <label for="agree-term" class="label-agree-term"><span>Reset password successfully! Redirecting to Sign In in <span id="countdown-timer">7 second(s)</span>.</span></label>
                            </div>
                            <script>
