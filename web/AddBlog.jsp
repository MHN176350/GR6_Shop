        ...
        <header>
            ...
            <div class="section">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <input type="text" name="btit" placeholder="Enter your blog title" class="form-input">
                    </div>
                    ...
                    <div class="row">
                      ...
                      <img id="image-preview" src="images/images-welcome.jpg" alt="images/images-welcome.jpg" style="margin-top: 20px; height: 250px;width: 400px; display: none" >
                      <input type="hidden" id="thumb-img" name="thumb">
                    </div>
                    <script>
            ...
            ele.value="images/"+tn;
                    ...
                    <div class="row">
                        ...
                        <textarea name="content" placeholder="Enter Blog Content" class="form-textarea"></textarea>
                    </div>
