...
public class AddBlog extends HttpServlet {
    ...
    throws ServletException, IOException {
        DAO d=new DAO();
          if(request.getParameter("aid").isEmpty() || request.getParameter("btit").isEmpty() || request.getParameter("cate").isEmpty() || request.getParameter("content").isEmpty()||request.getParameter("thumb").isEmpty()){
